(package-initialize)
;;配置文件路径
(add-to-list 'load-path (expand-file-name "cong" user-emacs-directory))
(add-to-list 'load-path (expand-file-name "~/.emacs.d/emacs-application-framework"))
...
(require 'init-ivy)
;;自动保存文件
(require 'init-save-file)
;;启动回到原来的界面
;;(require 'init-return-jiemian)
;;模板配置
(require 'init-muban)
;;代码自动补全 tabnine  auto-complete
;;(require 'init-auto-complete)
;;跳转光标的位置
;;(require 'init-ace-jump-mode)
;;快捷键的绑定
(require 'init-key)
;;撤销配置  undo-tree  ctrl u开启    ctrl /  撤销
...
;;使minibuffer显示在中间，左边，或者右边
(require 'init-minibuffer)
;;html<a></a>等标签的高亮
(require 'init-matching-tag)
;;web
(require 'init-web)
;;智能对齐
(require 'init-smart-align)
;;git
(require 'init-git)
;;web等标签的成对更改
(require 'init-rename-tag)
;;更好的语法高亮
(require 'init-flex)
;;自动排序css属性
(require 'init-css-sort)
;;shell配置
(require 'init-shell)
;;pdf
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (window-numbering mvn fancy-battery org cnfonts lsp-mode auto-complete-c-headers yasnippet-snippets xcscope winum which-key web-mode wc-mode visual-regexp use-package switch-window swiper-helm spaceline-all-the-icons smartparens smart-mode-line-atom-one-dark-theme session rjsx-mode rainbow-delimiters quickrun pyim proxy-mode powerline-evil pdf-tools pabbrev origami org-tree-slide org-pomodoro org-noter nyan-mode neotree multiple-cursors mu4e-alert modern-cpp-font-lock mode-icons meghanada magit lsp-typescript lsp-ruby lsp-python leetcode js3-mode ivy-xref ivy-posframe indent-guide iedit ibuffer-vc google-translate git-timemachine git-gutter-fringe git general fullframe flycheck-pos-tip flx eyebrowse exec-path-from-shell evil-visualstar evil-textobj-syntax evil-surround evil-nerd-commenter evil-matchit evil-lion evil-find-char-pinyin evil-exchange evil-escape evil-anzu emmet-mode elpy electric-spacing easy-after-load doom-themes doom-modeline dimmer diminish cquery counsel-projectile company-tabnine company-lsp color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized c-eldoc browse-at-remote benchmark-init auto-highlight-symbol auto-complete ace-window ace-jump-mode)))
...
(custom-set-faces
 ...
 '(mode-line ((t (:foreground "#f8f8f0" :background "#293739" :box nil))))
 '(mode-line-buffer-id ((t (:weight bold))))
 '(mode-line-inactive ((t (:foreground "#f8f8f0" :background "#455354" :box nil))))
