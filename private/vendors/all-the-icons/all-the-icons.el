...
(require 'data-folder       "./data/data-folder.el")
(require 'data-lang         "./data/data-lang.el")
...
(define-icon octicon    all-the-icons-data/octicons-alist       "")
...
(define-icon folder     all-the-icons-data/folder-alist "")
